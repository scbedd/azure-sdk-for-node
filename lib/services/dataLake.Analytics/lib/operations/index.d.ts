...
export interface Job {
     ...
     *
     * @param {string} parameters.type The job type of the current job (Hive, USql,
     * or Scope (for internal use only)). Possible values include: 'USql', 'Hive',
     * 'Scope'
     *
     ...
     * @param {object} [options] Optional Parameters.
     *
     * @param {object} [options.parameters] The parameters to update a job.
     *
     * @param {number} [options.parameters.degreeOfParallelism] The degree of
     * parallelism used for this job. This must be greater than 0, if set to less
     * than 0 it will default to 1.
     *
     * @param {number} [options.parameters.priority] The priority value for the
     * current job. Lower numbers have a higher priority. By default, a job has a
     * priority of 1000. This must be greater than 0.
     *
     * @param {object} [options.parameters.tags] The key-value pairs used to add
     * additional metadata to the job information.
     *
     * @param {object} [options.customHeaders] Headers that will be added to the
     * request
     *
     ...
     * @reject {Error|ServiceError} - The error object.
     */
    updateWithHttpOperationResponse(accountName: string, jobIdentity: string, options?: { parameters? : models.UpdateJobParameters, customHeaders? : { [headerName: string]: string; } }): Promise<HttpOperationResponse<models.JobInformation>>;
     ...
     *                      {http.IncomingMessage} [response] - The HTTP Response stream if an error did not occur.
     */
    update(accountName: string, jobIdentity: string, options?: { parameters? : models.UpdateJobParameters, customHeaders? : { [headerName: string]: string; } }): Promise<models.JobInformation>;
    update(accountName: string, jobIdentity: string, callback: ServiceCallback<models.JobInformation>): void;
    update(accountName: string, jobIdentity: string, options: { parameters? : models.UpdateJobParameters, customHeaders? : { [headerName: string]: string; } }, callback: ServiceCallback<models.JobInformation>): void;
     ...
     * @reject {Error|ServiceError} - The error object.
     */
    yieldMethodWithHttpOperationResponse(accountName: string, jobIdentity: string, options?: { customHeaders? : { [headerName: string]: string; } }): Promise<HttpOperationResponse<void>>;
     ...
     *                      {http.IncomingMessage} [response] - The HTTP Response stream if an error did not occur.
     */
    yieldMethod(accountName: string, jobIdentity: string, options?: { customHeaders? : { [headerName: string]: string; } }): Promise<void>;
    yieldMethod(accountName: string, jobIdentity: string, callback: ServiceCallback<void>): void;
    yieldMethod(accountName: string, jobIdentity: string, options: { customHeaders? : { [headerName: string]: string; } }, callback: ServiceCallback<void>): void;
     ...
     * @reject {Error|ServiceError} - The error object.
     */
    beginUpdateWithHttpOperationResponse(accountName: string, jobIdentity: string, options?: { parameters? : models.UpdateJobParameters, customHeaders? : { [headerName: string]: string; } }): Promise<HttpOperationResponse<models.JobInformation>>;
     ...
     *                      {http.IncomingMessage} [response] - The HTTP Response stream if an error did not occur.
     */
    beginUpdate(accountName: string, jobIdentity: string, options?: { parameters? : models.UpdateJobParameters, customHeaders? : { [headerName: string]: string; } }): Promise<models.JobInformation>;
    beginUpdate(accountName: string, jobIdentity: string, callback: ServiceCallback<models.JobInformation>): void;
    beginUpdate(accountName: string, jobIdentity: string, options: { parameters? : models.UpdateJobParameters, customHeaders? : { [headerName: string]: string; } }, callback: ServiceCallback<models.JobInformation>): void;
     ...
     * @reject {Error|ServiceError} - The error object.
     */
    beginCancelWithHttpOperationResponse(accountName: string, jobIdentity: string, options?: { customHeaders? : { [headerName: string]: string; } }): Promise<HttpOperationResponse<void>>;
     ...
     *                      {http.IncomingMessage} [response] - The HTTP Response stream if an error did not occur.
     */
    beginCancel(accountName: string, jobIdentity: string, options?: { customHeaders? : { [headerName: string]: string; } }): Promise<void>;
    beginCancel(accountName: string, jobIdentity: string, callback: ServiceCallback<void>): void;
    beginCancel(accountName: string, jobIdentity: string, options: { customHeaders? : { [headerName: string]: string; } }, callback: ServiceCallback<void>): void;
     ...
     * @reject {Error|ServiceError} - The error object.
     */
    beginYieldMethodWithHttpOperationResponse(accountName: string, jobIdentity: string, options?: { customHeaders? : { [headerName: string]: string; } }): Promise<HttpOperationResponse<void>>;
     ...
     *                      {http.IncomingMessage} [response] - The HTTP Response stream if an error did not occur.
     */
    beginYieldMethod(accountName: string, jobIdentity: string, options?: { customHeaders? : { [headerName: string]: string; } }): Promise<void>;
    beginYieldMethod(accountName: string, jobIdentity: string, callback: ServiceCallback<void>): void;
    beginYieldMethod(accountName: string, jobIdentity: string, options: { customHeaders? : { [headerName: string]: string; } }, callback: ServiceCallback<void>): void;
