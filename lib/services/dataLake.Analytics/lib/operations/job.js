 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
function _update(accountName, jobIdentity, options, callback) {
   /* jshint validthis: true */
  let client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
  ...
  // Send request
  this.beginUpdate(accountName, jobIdentity, options, (err, parsedResult, httpRequest, response) => {
...
function _cancel(accountName, jobIdentity, options, callback) {
  ...
  // Send request
  this.beginCancel(accountName, jobIdentity, options, (err, parsedResult, httpRequest, response) => {
    if (err) return callback(err);
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
function _yieldMethod(accountName, jobIdentity, options, callback) {
   /* jshint validthis: true */
  let client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
  ...
  // Send request
  this.beginYieldMethod(accountName, jobIdentity, options, (err, parsedResult, httpRequest, response) => {
    if (err) return callback(err);
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
function _beginUpdate(accountName, jobIdentity, options, callback) {
   /* jshint validthis: true */
  let client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
function _beginCancel(accountName, jobIdentity, options, callback) {
   /* jshint validthis: true */
  let client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
function _beginYieldMethod(accountName, jobIdentity, options, callback) {
   /* jshint validthis: true */
  let client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
  ...
  // Construct URL
  let baseUrl = this.client.baseUri;
  let requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'jobs/{jobIdentity}/YieldJob';
  requestUrl = requestUrl.replace('{accountName}', accountName);
  requestUrl = requestUrl.replace('{adlaJobDnsSuffix}', this.client.adlaJobDnsSuffix);
  requestUrl = requestUrl.replace('{jobIdentity}', encodeURIComponent(jobIdentity.toString()));
  let queryParameters = [];
...
class Job {
  ...
  constructor(client) {
    ...
    this._yieldMethod = _yieldMethod;
    this._build = _build;
    this._beginUpdate = _beginUpdate;
    this._beginCancel = _beginCancel;
    this._beginYieldMethod = _beginYieldMethod;
   ...
   * @reject {Error} - The error object.
   */
  updateWithHttpOperationResponse(accountName, jobIdentity, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._update(accountName, jobIdentity, options, (err, result, request, response) => {
        let httpOperationResponse = new msRest.HttpOperationResponse(request, response);
        httpOperationResponse.body = result;
        if (err) { reject(err); }
        else { resolve(httpOperationResponse); }
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  update(accountName, jobIdentity, options, optionalCallback) {
    let client = this.client;
    let self = this;
    if (!optionalCallback && typeof options === 'function') {
      optionalCallback = options;
    ...
    if (!optionalCallback) {
      ...
      return self._update(accountName, jobIdentity, options, optionalCallback);
    }
  }
   ...
   * @reject {Error} - The error object.
   */
  yieldMethodWithHttpOperationResponse(accountName, jobIdentity, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._yieldMethod(accountName, jobIdentity, options, (err, result, request, response) => {
        let httpOperationResponse = new msRest.HttpOperationResponse(request, response);
        httpOperationResponse.body = result;
        if (err) { reject(err); }
        else { resolve(httpOperationResponse); }
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  yieldMethod(accountName, jobIdentity, options, optionalCallback) {
    let client = this.client;
    let self = this;
    if (!optionalCallback && typeof options === 'function') {
      optionalCallback = options;
    ...
    if (!optionalCallback) {
      ...
      return self._yieldMethod(accountName, jobIdentity, options, optionalCallback);
    }
  }
   ...
   * @reject {Error} - The error object.
   */
  beginUpdateWithHttpOperationResponse(accountName, jobIdentity, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._beginUpdate(accountName, jobIdentity, options, (err, result, request, response) => {
        let httpOperationResponse = new msRest.HttpOperationResponse(request, response);
        httpOperationResponse.body = result;
        if (err) { reject(err); }
        else { resolve(httpOperationResponse); }
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  beginUpdate(accountName, jobIdentity, options, optionalCallback) {
    let client = this.client;
    let self = this;
    if (!optionalCallback && typeof options === 'function') {
      optionalCallback = options;
    ...
    if (!optionalCallback) {
      ...
      return self._beginUpdate(accountName, jobIdentity, options, optionalCallback);
    }
  }
   ...
   * @reject {Error} - The error object.
   */
  beginCancelWithHttpOperationResponse(accountName, jobIdentity, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._beginCancel(accountName, jobIdentity, options, (err, result, request, response) => {
        let httpOperationResponse = new msRest.HttpOperationResponse(request, response);
        httpOperationResponse.body = result;
        if (err) { reject(err); }
        else { resolve(httpOperationResponse); }
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  beginCancel(accountName, jobIdentity, options, optionalCallback) {
    let client = this.client;
    let self = this;
    if (!optionalCallback && typeof options === 'function') {
      optionalCallback = options;
    ...
    if (!optionalCallback) {
      ...
      return self._beginCancel(accountName, jobIdentity, options, optionalCallback);
    }
  }
   ...
   * @reject {Error} - The error object.
   */
  beginYieldMethodWithHttpOperationResponse(accountName, jobIdentity, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._beginYieldMethod(accountName, jobIdentity, options, (err, result, request, response) => {
        let httpOperationResponse = new msRest.HttpOperationResponse(request, response);
        httpOperationResponse.body = result;
        if (err) { reject(err); }
        else { resolve(httpOperationResponse); }
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  beginYieldMethod(accountName, jobIdentity, options, optionalCallback) {
    let client = this.client;
    let self = this;
    if (!optionalCallback && typeof options === 'function') {
      optionalCallback = options;
    ...
    if (!optionalCallback) {
      ...
      return self._beginYieldMethod(accountName, jobIdentity, options, optionalCallback);
    }
  }
