...
declare interface DataLakeAnalyticsJobManagementClientOptions extends AzureServiceClientOptions {
  /**
   * @property {string} [adlaJobDnsSuffix] - The DNS suffix used as the base for all Azure Data Lake Analytics Job service requests.
   */
...
export default class DataLakeAnalyticsJobManagementClient extends AzureServiceClient {
  /**
...
export { DataLakeAnalyticsJobManagementClient, models as DataLakeAnalyticsJobManagementModels };
