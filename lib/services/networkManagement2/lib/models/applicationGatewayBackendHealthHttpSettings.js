...
class ApplicationGatewayBackendHealthHttpSettings {
   ...
   * @property {number} [backendHttpSettings.port] Port
   * @property {string} [backendHttpSettings.protocol] Protocol. Possible
   ...
   * @property {string} [backendHttpSettings.name] Name of the resource that is
