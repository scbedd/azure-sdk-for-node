...
class IpsecPolicy {
   ...
   * VPN tunnel.
   * @property {number} saDataSizeKilobytes The IPSec Security Association
   * (also called Quick Mode or Phase 2 SA) payload size in KB for a site to
   * site VPN tunnel.
   * @property {string} ipsecEncryption The IPSec encryption algorithm (IKE
   ...
   * 'GCMAES192', 'GCMAES256'
   * @property {string} ikeEncryption The IKE encryption algorithm (IKE phase
   ...
   * @property {string} dhGroup The DH Groups used in IKE Phase 1 for initial
   * SA. Possible values include: 'None', 'DHGroup1', 'DHGroup2', 'DHGroup14',
   * 'DHGroup2048', 'ECP256', 'ECP384', 'DHGroup24'
   * @property {string} pfsGroup The DH Groups used in IKE Phase 2 for new
  ...
  /**
   * Defines the metadata of IpsecPolicy
   *
   * @returns {object} metadata of IpsecPolicy
   *
   */
  mapper() {
    return {
