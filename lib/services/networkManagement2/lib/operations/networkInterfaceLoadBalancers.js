...
function _list(resourceGroupName, networkInterfaceName, options, callback) {
  ...
  let requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/networkInterfaces/{networkInterfaceName}/loadBalancers';
    ...
    if (statusCode === 200) {
      ...
      try {
        ...
        if (parsedResponse !== null && parsedResponse !== undefined) {
          let resultMapper = new client.models['NetworkInterfaceLoadBalancerListResult']().mapper();
...
class NetworkInterfaceLoadBalancers {
  /**
...
module.exports = NetworkInterfaceLoadBalancers;
