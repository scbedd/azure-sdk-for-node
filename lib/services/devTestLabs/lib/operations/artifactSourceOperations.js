...
function _list(resourceGroupName, labName, options, callback) {
  ...
  let requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DevTestLab/labs/{labName}/artifactsources';
    ...
    if (statusCode === 200) {
      ...
      try {
        ...
        if (parsedResponse !== null && parsedResponse !== undefined) {
          let resultMapper = new client.models['ResponseWithContinuationArtifactSource']().mapper();
...
function _getResource(resourceGroupName, labName, name, options, callback) {
  ...
  // Construct URL
  let baseUrl = this.client.baseUri;
  let requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DevTestLab/labs/{labName}/artifactsources/{name}';
  requestUrl = requestUrl.replace('{subscriptionId}', encodeURIComponent(this.client.subscriptionId));
  requestUrl = requestUrl.replace('{resourceGroupName}', encodeURIComponent(resourceGroupName));
  requestUrl = requestUrl.replace('{labName}', encodeURIComponent(labName));
  ...
  return client.pipeline(httpRequest, (err, response, responseBody) => {
    ...
    if (statusCode === 200) {
      ...
      try {
        ...
        result = JSON.parse(responseBody);
        if (parsedResponse !== null && parsedResponse !== undefined) {
          let resultMapper = new client.models['ArtifactSource']().mapper();
          result = client.deserialize(resultMapper, parsedResponse, 'result');
        }
      } catch (error) {
        let deserializationError = new Error(`Error ${error} occurred in deserializing the responseBody - ${responseBody}`);
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
function _createOrUpdateResource(resourceGroupName, labName, name, artifactSource, options, callback) {
   /* jshint validthis: true */
  let client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
  ...
  try {
    ...
    if (artifactSource === null || artifactSource === undefined) {
      throw new Error('artifactSource cannot be null or undefined.');
    }
    if (this.client.apiVersion === null || this.client.apiVersion === undefined || typeof this.client.apiVersion.valueOf() !== 'string') {
      throw new Error('this.client.apiVersion cannot be null or undefined and it must be of type string.');
    }
  ...
  try {
    if (artifactSource !== null && artifactSource !== undefined) {
      let requestModelMapper = new client.models['ArtifactSource']().mapper();
      requestModel = client.serialize(requestModelMapper, artifactSource, 'artifactSource');
      requestContent = JSON.stringify(requestModel);
    }
  } catch (error) {
    let serializationError = new Error(`Error "${error.message}" occurred in serializing the ` +
        `payload - ${JSON.stringify(artifactSource, null, 2)}.`);
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
function _patchResource(resourceGroupName, labName, name, artifactSource, options, callback) {
   /* jshint validthis: true */
  let client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
...
class ArtifactSourceOperations {
   ...
   * @reject {Error} - The error object.
   */
  createOrUpdateResourceWithHttpOperationResponse(resourceGroupName, labName, name, artifactSource, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._createOrUpdateResource(resourceGroupName, labName, name, artifactSource, options, (err, result, request, response) => {
        let httpOperationResponse = new msRest.HttpOperationResponse(request, response);
        httpOperationResponse.body = result;
        if (err) { reject(err); }
        else { resolve(httpOperationResponse); }
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  createOrUpdateResource(resourceGroupName, labName, name, artifactSource, options, optionalCallback) {
    let client = this.client;
    let self = this;
    if (!optionalCallback && typeof options === 'function') {
      optionalCallback = options;
    ...
    if (!optionalCallback) {
      ...
      return self._createOrUpdateResource(resourceGroupName, labName, name, artifactSource, options, optionalCallback);
    }
  }
   ...
   * @reject {Error} - The error object.
   */
  patchResourceWithHttpOperationResponse(resourceGroupName, labName, name, artifactSource, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._patchResource(resourceGroupName, labName, name, artifactSource, options, (err, result, request, response) => {
        let httpOperationResponse = new msRest.HttpOperationResponse(request, response);
        httpOperationResponse.body = result;
        if (err) { reject(err); }
        else { resolve(httpOperationResponse); }
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  patchResource(resourceGroupName, labName, name, artifactSource, options, optionalCallback) {
    let client = this.client;
    let self = this;
    if (!optionalCallback && typeof options === 'function') {
      optionalCallback = options;
    ...
    if (!optionalCallback) {
      ...
      return self._patchResource(resourceGroupName, labName, name, artifactSource, options, optionalCallback);
    }
  }
...
module.exports = ArtifactSourceOperations;
